                ...
                <div class="formcontentsize" style="width:auto;height:auto;">
                    ...
                    <div class="layoutitem">
                        ...
                        <div class="layout-xx">
                            <ul>
                            	<li>
                            		<font size="6" color="black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;添加成功：</font><!-- <br><br> -->
                            	</li>
                            	<li>
                            		
									<center>
									<font size="5" color="black">订单编号：<%out.println(request.getAttribute("orid"));%></font>
									</center>
                            	</li>
                            	<li>
                            		
									<center>
									<font size="5" color="black">剩余库存量: <%out.println(request.getAttribute("num"));%></font>
									</center>
                            	</li>
                            </ul>
                        </div>
                    ...
                    <div class="layoutitem-add">
                        <a type="button" class="ui-xz" href="admin/orderinfor.jsp">确认</a>
                    </div>
