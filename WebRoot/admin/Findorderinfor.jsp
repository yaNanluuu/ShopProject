...
<script type="text/javascript">
  ...
  <body>
<%--   <jsp:useBean id="order1" class="cn.sdnu.erp.dao.jdbc.orderinforDaoJDBCImpl" scope="session"></jsp:useBean> --%>
										...
										<form method="post" action="">
											...
											<table class="gridbar" border="0" cellpadding="0"
												...
												<thead>
													...
													<!-- 订单信息展示 -->
													<%
													List<Orderinfor> orderinfors = (List<Orderinfor>)request.getAttribute("result"); 
										...
										<div class="layout-xx">
											<ul>
												...
												<li>
													...
													<div class="item-input">
														<label class="item-label">商品编号:</label> 
														<input type="text"
															value="<%=orderinfor.getgNo() %>" class="layoutitemcon" maxlength="50" readOnly="true">
													</div>
												</li>
												...
												<li>
													...
													<div class="item-input">
														...
														<input type="radio" name="upstat" value="有效" checked="checked">有效
